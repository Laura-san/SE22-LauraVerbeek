...
{
    public partial class AddToFilmography : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            List<Movie> movie = DatabaseManager.GiveMovies();
            foreach (Movie s in movie)
            {
                cbMovies.Items.Add(s.Title);
            }
        }
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            foreach (ListItem li in cbMovies.Items)
            {
                if (li.Selected)
                {
                    movies.Add((Convert.ToString(li)));
                }
            }
            Session["movie"] = movies;
            Response.Redirect("AddActor.aspx");
        }
    }
}