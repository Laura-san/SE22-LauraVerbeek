...
<body>
    ...
    <div id ="left" style="width: 121px; height: 267px; float: left;">
        ...
        <div id="right" style="float: left; width: 616px; height:268px;">
            ...
            <asp:ListBox ID="lbMovies" runat="server" Height="265px" Width="602px"></asp:ListBox>
            <asp:Button ID="btn_viewMovie" runat="server" Text="View Movie!" Width="602px" OnClick="btn_viewMovie_Click" />
        </div>
        <p>
            &nbsp;</p>
        <p>
