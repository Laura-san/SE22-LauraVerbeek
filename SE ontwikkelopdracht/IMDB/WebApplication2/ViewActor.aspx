<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewActor.aspx.cs" Inherits="WebApplication2.ViewActor" %>
...
<body>
    ...
    <div id ="left" style="width: 121px; height: 267px; float: left;">
        ...
        <div id="search" style="float: left; width: 616px; height:268px;">
            ...
            <asp:Label ID="lblName" runat="server" Font-Size="XX-Large" Text="Label"></asp:Label><br />
            <asp:Label ID="lblDOB" runat="server" Text="Date of birth:"></asp:Label>
            <asp:TextBox ID="tbDOB" runat="server" Width="349px" ReadOnly="True"></asp:TextBox><br />
            <asp:Label ID="lblBio" runat="server" Text="Biography:"></asp:Label><br />
            <asp:TextBox ID="tbBio" runat="server" Height="174px" Width="427px" ReadOnly="True"></asp:TextBox>
        </div>
        </div>
    </form>
</body>
