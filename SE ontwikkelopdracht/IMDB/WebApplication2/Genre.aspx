<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Genre.aspx.cs" Inherits="WebApplication2.Genre" %>
...
<body>
    ...
    <div id ="left" style="width: 121px; height: 267px; float: left;">
        ...
        <div id="search" style="float: left; width: 616px; height:268px;">
            ...
            <asp:ListBox ID="lbGenre" runat="server" Height="265px" Width="602px"></asp:ListBox>
        </div>
        </div>
    </form>
</body>
